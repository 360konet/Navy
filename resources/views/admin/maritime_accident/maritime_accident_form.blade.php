...
<form method="POST" action="{{url('/add-maritime-accident')}}">
    @csrf
    <center><img src="{{asset('logo.jpg')}}" height="100px" width="100px"></center>
    <h2>Maritime Accident Form</h2> 

    <!-- Submit Button -->
    <button type="submit" style="float:right" value="submit">Submit</button><br>
   ...
   <div class="form-section">
    ...
    <label for="otherAccident" id="otherAccidentLabel" style="display:none;">Enter Other Accident</label>
    <input type="text" id="otherAccident" name="other_accident" placeholder="Enter Other Accident" style="display:none;">
</div>
...
<script>
    ...
    <label for="vesselInvolved">Vessel(s) Involved:

</label>
    <input type="text" class="vesselInput" name="vessel_involved[]" required placeholder="Enter MMSI">
    </div>
